#******************************************************************************
#* Name          	: README_PxPay_PHP_OpenSSL.txt
#* Description   	: Windcave PxPay PHP OpenSSL Sample
#* Copyright	 	: Windcave 2017(c)
#* Date          	: 2017-04-10
#* References    	: https://www.windcave.com/developer-e-commerce-paymentexpress-hosted-pxpay
#*@version 		    : 2.0
...
This PHP script is a sample, intended to demonstrate how a merchant can use the Windcave Secure Payment Page from a PHP website.
...
then obtain payment authorization via the Windcave Secure Payments Page.

There are two files included in the release:
	1. pxpay.inc.php 
	   -- PHP include file which contains classes for Payments Page
	2. PxPay_Sample_OpenSSL.php
	   -- For clients with the OpenSSL PHP extension on their host
	   -- Sample code to post payment and process response using PxPay_OpenSSL,
...
============
   ...
   1. Install PxPay_Sample_OpenSSL.php and PxPay_OpenSSL.inc.php wherever you put your PHP scripts.
   2. Set your PxPay UserId and PxPay Key in the PxPay_Sample_OpenSSL.php file into the variables 
      $PxPay_Userid and $PxPay_Key

DISCLAIMER
============
Software downloaded from the Windcave web site is provided 'as is' without warranty of any kind,
...
Without limiting the foregoing, the Windcave makes no warranty that:
...
Software and its documentation made available on the Windcave web site could include technical or other mistakes,
inaccuracies or typographical errors. Windcave may make changes at any time to the software or documentation made
available on its web site.


Windcave assumes no responsibility for errors or omissions in the software or documentation available from its web site.