...
include "PxPay_Curl.inc.php";
  ...
  $PxPay_Url    = "https://uat.windcave.com/pxaccess/pxpay.aspx"; # Production https://sec.windcave.com/pxaccess/pxpay.aspx
  # Please update below with the PxPay credentials - if the PxPay credentials are not available, please contact suppport@windcave.com to receive them.
  $PxPay_Userid = "RentalListingsLimited_DEV_A2A";
  $PxPay_Key    = "8e288f530b7b0dd64558646b187e323d852bee7d45587d9e152e5d1fd7336ea5";
...
function redirect_form()
{
  ...
  $request->setEmailAddress("your_email@windcave.com");
