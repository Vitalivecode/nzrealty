    <?php if(isset($small) && $small == 6){ ?><div class="row"><h4 class="ml-3 mb-4 fs-18 lh-15 text-heading">Choose a package that suits your business </h4><br><small class="text-danger">Free subscription for first 12 months, If registered before Date 31st December 2024.</small></div><?php } ?>
    <div class="row">
