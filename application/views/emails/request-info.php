                    ...
                    <tr>
                      <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;" align="left">
                        ...
                        <p style="margin: 0 0 24px;">
                          You have successfully booked in to view <strong><?=($propertyDetails != false)?$propertyDetails[0]->address:'';?></strong> on <strong><?=date('d-m-Y h:i A', strtotime($datetime));?></strong>.
                        </p>
                        ...
                        <p style="margin: 0 0 24px;">
                            If you would like to cancel the booking you can go to your dashboard and cancel it in schedules section or <a href="<?=$refererURL;?>">click here</a>
                        </p>
