...
<head>
  ...
  <body style="margin: 0; padding: 0; width: 100%; word-break: break-word; -webkit-font-smoothing: antialiased; --bg-opacity: 1; background-color: #eceff1;">
    ...
    <div role="article" aria-roledescription="email" aria-label="Book a view" lang="en">
                    ...
                    <tr>
                      <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;" align="left">
                        ...
                        <p style="margin: 24px 0;">
                          You have successfully booked in to view <strong><?=($propertyDetails != false)?$propertyDetails[0]->address:'';?></strong> on <strong><?=date('d-m-Y h:i A', strtotime($datetime));?></strong><br/>
                        </p>
                        <p style="margin: 0 0 24px;" align="center">
                            <a href="<?=$refererURL;?>" target="_blank">
                              <img src="<?=base_url('uploads/small/'.$propertyDetails[0]->images);?>" width="50%" alt="<?=($propertyDetails != false)?$propertyDetails[0]->address:'';?>" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle;">
                            </a>
                        </p>
                        <p style="margin: 0 0 24px;">
                            <a href="https://www.google.com/maps/dir/Current+Location/<?=($propertyDetails != false)?$propertyDetails[0]->latitude.','.$propertyDetails[0]->longitude:'';?>" target="_blank">Click here</a> for directions
                        </p>
                        <p style="margin: 0 0 24px;">
                            Contact/Get in touch:<br>
                          <span style="font-weight: 600;"><strong><?=$agentDetails[0]->name;?></strong></span><br />
                          <strong>Phone Number:</strong> <?=$agentDetails[0]->phone;?><br />
                          <strong>Email:</strong> <?=$agentDetails[0]->email;?><br />
                          <?php if(isset($company)){ ?>
                          <strong>Company Name:</strong> <?=$company[0]->name;?>
                          <?php } ?>
                        </p>
                        <p style="margin: 0 0 24px;">
                          If you would like to cancel the booking you can go to your dashboard and cancel it in schedules section or click the link below <a href="<?=$refererURL;?>" target="_blank">here</a>
                        </p>
                        <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
