                    ...
                    <tr>
                      <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;" align="left">
                        ...
                        <p style="margin: 24px 0;">
                          Your property is successfully submitted and waiting for approval.
                        </p>
                        <p style="margin: 0 0 24px;" align="center">
                            <strong><?=($propertyDetails != false)?$propertyDetails[0]->address:'';?></strong><br/>
                            <?php if($role != 'landlord'){ ?>
                            You can view by clicking the link below.<br />
                            <a href="<?=$refererURL;?>" style="display: block; font-size: 14px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #7367f0;  text-decoration: none;"><?=$refererURL;?></a>
                        ...
                        <?php if(!empty($addons)){ ?> 
                            <p style="margin: 0 0 10px;font-weight: 600; font-size: 18px; margin-bottom: 0;">Addon's</p>
                            <?php foreach($addons as $key => $addon){ ?>
                                <p style="margin: 0 0 10px;"><?=(isset($propertyDetails) && $propertyDetails != false && $propertyDetails[0]->$key == '1')?$addon->name:'';?></p>
                        <?php } } ?>
                        <?php if($role == 'landlord'){ ?>
