...
{
    // default connection
    public static $dbname = 'rentallistings'; // Your database name
    ...
    // map
    public static $default_point = '-42.1, 172.77';
    ...
    //Maps Api Key Pranay
    public static $maps_key = 'AIzaSyAqNNTR2We4jusBoiiFwvtwLpqfBvU5XoU&callback=initMap';
