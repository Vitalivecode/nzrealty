...
class GPS
{
    ...
    public function column_head($fields = '', $style = '')
    {
        if ($fields && $style)
        {
            $fdata = $this->_parse_field_names($fields, 'column_head');
            foreach ($fdata as $fitem)
            {
                $this->column_head[$fitem['table'] . '.' . $fitem['field']] = $style;
            }
        }
        return $this;
    }
    ...
    public static function check_url($url, $scr_url = false)
    {
        ...
        $scheme = (!isset($_SERVER['HTTPS']) or !$_SERVER['HTTPS'] or strtolower($_SERVER['HTTPS']) == 'off' or strtolower($_SERVER['HTTPS']) ==
            'no') ? 'https://' : 'https://';
        // changed here code from http:// https;//
    ...
    public static function load_js()
    {
        ...
        if (GPS_config::$load_googlemap)
            $out .= '<script src="//maps.google.com/maps/api/js?key='.GPS_config::$maps_key.'&language='.$language.'"></script>';
            ...
            '&uarr; ', 'desc' => '&darr; '))
    {
        ...
        foreach ($this->columns as $field => $fitem)
        {
            ...
            if (isset($this->column_head[$field]))
            {
                $attr['style'] = $this->column_head[$field]. ';';
            }
